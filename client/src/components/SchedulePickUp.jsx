...
function SchedulePickUp() {
  ...
  const genAI = new GoogleGenerativeAI(
    "AIzaSyAqscMBZ1AfjD-btAPZcHBv-yHgZp2Cwwo"
        ...
        contents: [
          {
            parts: [
              {
                text: "Identify the waste type in the image. Respond with only one word from this list: 'Plastic', 'Paper', 'Glass', 'Metal', 'E-waste', 'Cardboard', 'Wood', 'Fabric', or 'Cotton'. Do not provide any explanation.",
              },
              {
                inlineData: {
                  mimeType: "image/jpeg",
